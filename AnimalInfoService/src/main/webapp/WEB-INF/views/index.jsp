...
<body>
        ...
        <div class="main_banner_contents">
            ...
            <div class="banner_contents">
                <div class="content_left">
                    <p class="ani_title">하루간 발견된</p>
                    <p class="ani_number">강아지 ${cnt.strCnt} 마리</p>
                    <p class="ani_number">고양이 ${c_cnt.c_strCnt} 마리</p>
                    <p class="ani_number">기타동물 ${o_cnt.o_strCnt} 마리</p>
                </div>
                <div class="content_mid">
                    ...
                    <p class="ani_number">기타동물 ${o_allCnt.o_strAllCnt} 마리</p>
                </div>
            </div>
        </div>
    </div>
    <div class="container">
        ...
        <div class="dashboard_content">
            ...
            <div class="content_mid live_confirm_area">
                <h1>어디에서 동물들이 가족을 많이 잃었나요?</h1>
                <canvas id="o_region_status" style="width: 100%; height: 100%;"></canvas>
            </div>
            <div class="pie_chart_area">
                <div class="content_right">
                    <h1>유기 된 기타동물 성별비율</h1>
                    <canvas id="o_sex_chart" style="width: 100%; height: 100%;"></canvas>
                </div>
                <div class="content_right">
                    <h1>유기 된 기타동물 중성화</h1>
                    <canvas id="o_neuter_chart" style="width: 100%; height: 100%;"></canvas>
                </div>
            </div>
        </div>
        <div class="dashboard_content">
